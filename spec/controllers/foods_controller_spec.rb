  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved food as @food" do
        ...
        post :create, {:food => { "company_name" => "invalid value" }}, valid_session
        assigns(:food).should be_a_new(Food)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested food" do
        ...
        Food.any_instance.should_receive(:update).with({ "company_name" => "MyString" })
        put :update, {:id => food.to_param, :food => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the food as @food" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Food.any_instance.stub(:save).and_return(false)
        put :update, {:id => food.to_param, :food => { "company_name" => "invalid value" }}, valid_session
        assigns(:food).should eq(food)
      end
